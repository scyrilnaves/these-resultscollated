...
input_data <-
  read.csv(file = '/home/renault/Documents/code/results/datamarket/Rscript/csvdata/auraforks.csv')
...
ggplot(data = input_data, aes(x = Nodes, y = Forks)) + geom_line(aes(colour =
  ...
  ) + ggtitle("Authority Round Forks Influence")


#Save Figure
dev.copy(png, filename = '/home/renault/Documents/code/results/datamarket/Rscript/plots/auraforks.png')
