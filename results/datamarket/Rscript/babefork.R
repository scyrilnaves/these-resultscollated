...
input_data <-
  read.csv(file = '/home/renault/Documents/code/results/datamarket/Rscript/csvdata/babeforks.csv')
...
ggplot(data = input_data, aes(x = Nodes, y = Forks)) + geom_line(aes(colour =
  ...
  ) + ggtitle("Blind Assignment for Blockchain Extension \n Consensus Scalability Forks Influence")


#Save Figure
dev.copy(png, filename = '/home/renault/Documents/code/results/datamarket/Rscript/plots/babeforks.png')
