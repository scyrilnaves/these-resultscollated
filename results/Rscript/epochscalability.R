...
input_data <-
  read.csv(file = '/home/renault/Documents/code/results/Rscript/csvdata/epochscalability.csv')
...
ggplot(data = input_data, aes(x = Node, y = TransactionRate)) + geom_line(aes(colour =
  ...
  ) + ggtitle("Epoch Limit Influence")

#Save Figure
dev.copy(png, filename = '/home/renault/Documents/code/results/Rscript/plots/epochscalability.png')
dev.off ()
