...
input_data <- read.csv(file ='/home/renault/Documents/code/results/Rscript/csvdata/conclusion.csv')
...
#Save Figure
dev.copy(png,filename='/home/renault/Documents/code/results/Rscript/plots/overallcomparison.png');
dev.off ();
