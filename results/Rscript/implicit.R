...
input_data <-
  read.csv(file = '/home/renault/Documents/code/results/Rscript/csvdata/implicit.csv')
...
ggplot(data = input_data, aes(x = Node, y = TransactionRate)) + geom_line(aes(colour =
  ...
  ) + ggtitle("Implicit Variant Comparison")


#Save Figure
dev.copy(png, filename = '/home/renault/Documents/code/results/Rscript/plots/implicit.png')
